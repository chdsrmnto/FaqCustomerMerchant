...
public class Customer extends JFrame {
    ...
    private String[] faqQuestions = {"What is HomeCredit?", "How do I apply for a loan?\", \"How much is the down payment?\", \"What types of loans do you offer?", "How does HomeCredit work?"};
    private String[] faqAnswers = {  		
        "HomeCredit is a financial services company that provides consumer finance products, primarily \nfocusing on offering installment loans and point-of-sale loans for purchases such as electronics, \nappliances, and other durable goods.",
        ...
        "HomeCredit offers loans to consumers for purchasing various products, with the repayment structured \n"
        + "in installments over a predetermined period. Customers can apply for a loan either online, through \n"
        + "a mobile app, or at partnered retail stores where HomeCredit operates."
    };
    ...
    public Customer() {
        ...
        panel.add(scrollPane);
                ...
                faqDropdown.setModel(new DefaultComboBoxModel(new String[] {"What is HomeCredit?", "How do I apply for a loan?", "How much is the down payment?", "What types of loans do you offer?", "How does HomeCredit work?"}));
